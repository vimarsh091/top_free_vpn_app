...
internal class NetworkSetting(prefs: SharedPreferences) {
    ...
    internal val PPP_MRU = /*getIntPrefValue(OscPreference.PPP_MRU, prefs)*/ 1500
    internal val PPP_MTU =/* getIntPrefValue(OscPreference.PPP_MTU, prefs)*/ 1500
    internal val PPP_PAP_ENABLED = /*getBooleanPrefValue(OscPreference.PPP_PAP_ENABLED, prefs)*/ true
    internal val PPP_MSCHAPv2_ENABLED = /*getBooleanPrefValue(OscPreference.PPP_MSCHAPv2_ENABLED, prefs)*/ true
    internal val PPP_AUTH_TIMEOUT = /*getIntPrefValue(OscPreference.PPP_AUTH_TIMEOUT, prefs)*/ 3
    internal val PPP_IPv4_ENABLED = /*getBooleanPrefValue(OscPreference.PPP_IPv4_ENABLED, prefs)*/ true
    internal val PPP_IPv6_ENABLED = /*getBooleanPrefValue(OscPreference.PPP_IPv6_ENABLED, prefs)*/false
    internal val IP_PREFIX = /*getIntPrefValue(OscPreference.IP_PREFIX, prefs)*/ 0
    internal val IP_ONLY_LAN = /*getBooleanPrefValue(OscPreference.IP_ONLY_LAN, prefs)*/ false
    internal val IP_ONLY_ULA = /*getBooleanPrefValue(OscPreference.IP_ONLY_ULA, prefs)*/ false
    internal val BUFFER_INCOMING = /*getIntPrefValue(OscPreference.BUFFER_INCOMING, prefs)*/16384
    internal val BUFFER_OUTGOING = /*getIntPrefValue(OscPreference.BUFFER_OUTGOING, prefs)*/ 16384
    internal val LOG_DO_SAVE_LOG = /*getBooleanPrefValue(OscPreference.LOG_DO_SAVE_LOG, prefs)*/ false
